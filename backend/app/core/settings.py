...
class Settings(BaseModel):
    ...
    quality_sequence_cluster_window_seconds: float = 3.0
    quality_sequence_bad_neighbor_penalty: float = 0.18
    quality_sequence_min_cluster_similarity: float = 0.86
    ...
    quality_duplicate_low_text_visual_threshold: float = 0.90
    quality_duplicate_far_visual_threshold: float = 0.92
    quality_duplicate_near_visual_threshold: float = 0.88
    quality_duplicate_content_match_threshold: float = 0.055
